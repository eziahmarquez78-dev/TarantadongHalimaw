...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "gumawa ng anime avatar na may signature"
		},
		category: "image",
		guide: {
			...
			tl: "   {p}{n} <id o pangalan ng character> | <background text> | <signature> | <pangalan ng kulay o hex color code>"
				+ "\n   {p}{n} help: tingnan kung paano gamitin ang command"
		}
	},
	...
	langs: {
		...
		tl: {
			initImage: "Ginagawa ang larawan, sandali lang po...",
			invalidCharacter: "Kasalukuyan, %1 lang ang character sa system, pakilagay ng mas maliit na character id",
			notFoundCharacter: "Walang nahanap na character na pangalang %1 sa listahan ng character",
			errorGetCharacter: "May naganap na error sa pagkuha ng datos ng character:\n%1: %2",
			success: "✅ Avatar mo\nCharacter: %1\nID: %2\nBackground text: %3\nSignature: %4\nKulay: %5",
			defaultColor: "default",
