...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "Idisenyo ang rank card ayon sa gusto mo"
		},
		category: "rank",
		guide: {
			vi: {
			...
			tl: {
				body: "   {pn} [maincolor | subcolor | linecolor | expbarcolor | progresscolor | alphasubcolor | textcolor | namecolor | expcolor | rankcolor | levelcolor | reset] <value>"
					+ "\n   Kung saan: "
					+ "\n  + maincolor | background <value>: pangunahing background ng rank card"
					+ "\n  + subcolor <value>: pangalawang background"
					+ "\n  + linecolor <value>: kulay ng linya sa pagitan ng pangunahin at pangalawang background"
					+ "\n  + expbarcolor <value>: kulay ng exp bar"
					+ "\n  + progresscolor <value>: kulay ng kasalukuyang exp bar"
					+ "\n  + alphasubcolor <value>: pagka-transparent ng pangalawang background (mula 0 -> 1)"
					+ "\n  + textcolor <value>: kulay ng teksto (hex color o rgba)"
					+ "\n  + namecolor <value>: kulay ng pangalan"
					+ "\n  + expcolor <value>: kulay ng exp"
					+ "\n  + rankcolor <value>: kulay ng rank"
					+ "\n  + levelcolor <value>: kulay ng level"
					+ "\n    • <value> pwedeng hex color, rgb, rgba, gradient (bawat kulay pinaghihiwalay ng espasyo) o url ng larawan"
					+ "\n    • Kung gusto mong gumamit ng gradient, maglagay ng maraming kulay na pinaghihiwalay ng espasyo"
					+ "\n   {pn} reset: ibalik lahat sa default"
					+ "\n   Halimbawa:"
					+ "\n    {pn} maincolor #fff000"
					+ "\n    {pn} maincolor #0093E9 #80D0C7"
					+ "\n    {pn} subcolor rgba(255,136,86,0.4)"
	...
	langs: {
		...
		tl: {
			invalidImage: "Hindi valid ang image url, pumili ng url na patungo sa larawan (jpg, jpeg, png, gif), pwede kang mag-upload ng larawan sa https://imgbb.com/ at piliin ang \"get direct link\" para makuha ang image url",
			invalidAttachment: "Hindi larawan ang attachment, pumili ng image file",
			invalidColor: "Hindi valid ang color code, pumili ng hex color code (6 digits) o rgba color code",
			notSupportImage: "Hindi suportado ang image url sa option na \"%1\"",
			success: "Na-save na ang mga binago mo, ito ang preview",
			reseted: "Naibalik na sa default ang lahat ng setting",
			invalidAlpha: "Pumili ng numero mula 0 -> 1"
		}
	},
