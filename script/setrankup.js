...
module.exports = {
	config: {
		...
		guide: {
			...
			tl: "   {pn} text <mensahe>: I-configure ang mensahe kapag nag-rankup ang miyembro sa chatbox mo"
				+ "\n   Gamit ang mga sumusunod na parameter:"
				+ "\n    + {userName}: Pangalan ng miyembro"
				+ "\n    + {userNameTag}: I-tag ang pangalan ng miyembro"
				+ "\n    + {oldRank}: Dating rank ng miyembro"
				+ "\n    + {currentRank}: Kasalukuyang rank ng miyembro"
				+ "\n   {pn} file <link>: I-configure ang attachment na file kapag nag-rankup ang miyembro sa chatbox mo"
				+ "\n   {pn} reset: Ibalik sa default na configuration"
		}
	},
	...
	langs: {
		...
		tl: {
			changedMessage: "Napalitan na ang mensahe ng rankup tungong: %1",
			missingAttachment: "Kailangan mo maglagay ng larawan para i-configure ang rankup image",
			changedAttachment: "Matagumpay na nadagdag ang %1 attachment sa rankup"
		}
	},
