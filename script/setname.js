...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "Palitan ang palayaw ng lahat ng miyembro sa group chat o ng mga na-tag na miyembro gamit ang isang format"
		},
		category: "box chat",
		guide: {
			vi: {
			...
			tl: {
				body: "   {pn} <palayaw>: palitan ang sariling palayaw"
					+ "\n   {pn} @tags <palayaw>: palitan ang palayaw ng mga na-tag na miyembro"
					+ "\n   {pn} all <palayaw>: palitan ang palayaw ng lahat ng miyembro sa group chat"
					+ "\n\n   May mga available na shortcut:"
					+ "\n   + {userName}: pangalan ng miyembro"
					+ "\n   + {userID}: ID ng miyembro"
					+ "\n\n   Halimbawa: (tingnan ang larawan)",
				attachment: {
					[`${__dirname}/assets/guide/setname_1.png`]: "https://i.ibb.co/gFh23zb/guide1.png",
					[`${__dirname}/assets/guide/setname_2.png`]: "https://i.ibb.co/BNWHKgj/guide2.png"
				}
	...
	langs: {
		...
		tl: {
			error: "May naganap na error, subukang i-off ang invite link feature sa group at ulitin muli mamaya"
		}
	},
