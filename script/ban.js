...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "I-ban ang miyembro sa box chat"
		},
		category: "box chat",
		guide: {
			...
			tl: "   {pn} [@tag|uid|fb link|reply] [<dahilan>|iwanang blangko kung walang dahilan]: I-ban ang miyembro sa box chat"
				+ "\n   {pn} check: Tignan ang mga na-ban na miyembro at i-kick sila sa box chat"
				+ "\n   {pn} unban [@tag|uid|fb link|reply]: Alisin ang ban ng miyembro sa box chat"
				+ "\n   {pn} list: Tignan ang listahan ng mga na-ban na miyembro"
		}
	},
	...
	langs: {
		...
		tl: {
			notFoundTarget: "⚠️ | Pakitag ang taong gustong i-ban o maglagay ng uid o fb link o mag-reply sa mensahe ng taong gustong i-ban",
			notFoundTargetUnban: "⚠️ | Pakitag ang taong gustong alisan ng ban o maglagay ng uid o fb link o mag-reply sa mensahe ng taong gustong alisan ng ban",
			userNotBanned: "⚠️ | Ang taong may id %1 ay hindi naka-ban sa box chat na ito",
			unbannedSuccess: "✅ | Na-alis na ang ban ni %1 sa box chat!",
			cantSelfBan: "⚠️ | Hindi mo pwedeng i-ban ang sarili mo!",
			cantBanAdmin: "❌ | Hindi mo pwedeng i-ban ang administrator!",
			existedBan: "❌ | Naka-ban na ang taong ito noon pa!",
			noReason: "Walang dahilan",
			bannedSuccess: "✅ | Na-ban si %1 sa box chat!",
			needAdmin: "⚠️ | Kailangan ng bot ng admin permission para ma-kick ang mga na-ban na miyembro",
			noName: "Facebook user",
			noData: "📑 | Walang na-ban na miyembro sa box chat na ito",
			listBanned: "📑 | Listahan ng mga na-ban na miyembro sa box chat na ito (pahina %1/%2)",
			content: "%1/ %2 (%3)\nDahilan: %4\nOras ng pag-ban: %5\n\n",
			needAdminToKick: "⚠️ | Na-ban na si %1 (%2) sa box chat, pero wala pang admin permission ang bot para ma-kick ang miyembrong ito, pakibigyan ng admin permission ang bot para ma-kick siya",
			bannedKick: "⚠️ | Naka-ban na si %1 sa box chat noon pa!\nUID: %2\nDahilan: %3\nOras ng pag-ban: %4\n\nAwtomatikong kinick ng bot ang miyembrong ito"
		}
	},
