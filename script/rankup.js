...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "I-on/off ang abiso pag level up"
		},
		category: "rank",
		guide: {
			en: "{pn} [on | off]",
	...
	langs: {
		...
		tl: {
			syntaxError: "Maling gamit, {pn} on o {pn} off lang ang pwede",
			turnedOn: "Na-on na ang abiso pag level up",
			turnedOff: "Na-off na ang abiso pag level up",
			notiMessage: "🎉🎉 Congrats, umabot ka na sa level %1"
		}
	},
