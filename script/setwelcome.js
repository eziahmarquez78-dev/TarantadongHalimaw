...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "I-edit ang mensaheng pambati para sa bagong miyembro na sumali sa group chat mo"
		},
		category: "custom",
		guide: {
			vi: {
			...
			tl: {
				body: "   {pn} text [<nilalaman> | reset]: i-edit ang teksto o i-reset pabalik sa default, may mga available na shortcut:"
					+ "\n  + {userName}: pangalan ng bagong miyembro"
					+ "\n  + {userNameTag}: pangalan ng bagong miyembro (tag)"
					+ "\n  + {boxName}:  pangalan ng group chat"
					+ "\n  + {multiple}: ikaw || kayo"
					+ "\n  + {session}:  oras ng araw"
					+ "\n\n   Halimbawa:"
					+ "\n    {pn} text Kamusta {userName}, welcome sa {boxName}, magandang araw sa {multiple}"
					+ "\n"
					+ "\n   Mag-reply o magpadala ng mensaheng may file kasama ang {pn} file: para magdagdag ng attachment sa welcome message (larawan, video, audio)"
					+ "\n\n   Halimbawa:"
					+ "\n    {pn} file reset: tanggalin ang attachment",
				attachment: {
					[`${__dirname}/assets/guide/setwelcome/setwelcome_en_1.png`]: "https://i.ibb.co/vsCz0ks/setwelcome-en-1.png"
				}
			}
	...
	langs: {
		...
		tl: {
			turnedOn: "Na-on na ang welcome message",
			turnedOff: "Na-off na ang welcome message",
			missingContent: "Pakilagay ang nilalaman ng welcome message",
			edited: "Na-edit na ang welcome message ng group mo tungong: %1",
			reseted: "Na-reset na ang nilalaman ng welcome message",
			noFile: "Walang attachment sa welcome message na pwedeng burahin",
			resetedFile: "Matagumpay na na-reset ang attachment",
			missingFile: "Pakireply sa mensaheng ito na may kasamang larawan/video/audio file",
			addedFile: "Nadagdag ang %1 na attachment sa welcome message ng group mo"
		}
	},
