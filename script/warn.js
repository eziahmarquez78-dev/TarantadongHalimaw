...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "bigyan ng babala ang miyembro sa group, pag umabot ng 3 beses babanan sa box"
		},
		category: "box chat",
		guide: {
			...
			tl: "   {pn} @tag <dahilan>: bigyan ng babala ang miyembro"
				+ "\n   {pn} list: tingnan ang listahan ng mga nabalaang miyembro"
				+ "\n   {pn} listban: tingnan ang listahan ng mga na-ban na miyembro"
				+ "\n   {pn} info [@tag | <uid> | reply | iwanang blangko]: tingnan ang impormasyon ng babala ng na-tag na tao o uid o sarili mo"
				+ "\n   {pn} unban [@tag | <uid> | reply | iwanang blangko]: alisin ang ban ng miyembro, kasabay ang lahat ng babala niya"
				+ "\n   {pn} unwarn [@tag | <uid> | reply | iwanang blangko] [<numero> | iwanang blangko]: alisin ang babala ng miyembro gamit ang uid at numero ng babala, kung iiwanang blangko ang huling babala ang mababawi"
				+ "\n   {pn} reset: i-reset ang lahat ng datos ng babala"
				+ "\n⚠️ Kailangan mo i-set na admin ang bot para awtomatikong ma-kick ang mga na-ban na miyembro"
		}
	},
	...
	langs: {
		...
		tl: {
			list: "Listahan ng mga nabalaang miyembro:\n%1\n\nPara tingnan ang detalye ng mga babala gamitin ang command na \"%2warn info [@tag | <uid> | iwanang blangko]\": para tingnan ang impormasyon ng babala ng na-tag na tao o uid o sarili mo",
			listBan: "Listahan ng mga miyembrong nabalaan ng 3 beses at na-ban sa box:\n%1",
			listEmpty: "Wala pang nabalaang miyembro sa group mo",
			listBanEmpty: "Wala pang na-ban na miyembro sa box ng group mo",
			invalidUid: "Pakilagay ng valid na uid ng taong gusto mong tingnan",
			noData: "Walang datos",
			noPermission: "❌ Admin ng group lang ang pwedeng mag-unban ng na-ban na miyembro sa box",
			invalidUid2: "⚠️ Pakilagay ng valid na uid ng taong gustong alisan ng ban",
			notBanned: "⚠️ Ang user na may id %1 ay hindi pa naka-ban sa box mo",
			unbanSuccess: "✅ Naalis na ang ban ng miyembrong [%1 | %2], pwede na siyang sumali sa box chat mo",
			noPermission2: "❌ Admin ng group lang ang pwedeng mag-alis ng babala ng miyembro sa group",
			invalidUid3: "⚠️ Pakilagay ng uid o i-tag ang taong gustong alisan ng babala",
			noData2: "⚠️ Ang user na may id %1 ay wala pang datos ng babala",
			notEnoughWarn: "❌ Ang user na si %1 ay %2 babala lang ang meron",
			unwarnSuccess: "✅ Matagumpay na naalis ang ika-%1 babala ng miyembrong [%2 | %3]",
			noPermission3: "❌ Admin ng group lang ang pwedeng mag-reset ng datos ng babala",
			resetWarnSuccess: "✅ Matagumpay na na-reset ang datos ng babala",
			noPermission4: "❌ Admin ng group lang ang pwedeng magbigay ng babala sa miyembro ng group",
			invalidUid4: "⚠️ Kailangan mong i-tag o i-reply ang mensahe ng taong gustong bigyan ng babala",
			warnSuccess: "⚠️ Binigyan ng babala si %1 sa ika-%2 beses\n- Uid: %3\n- Dahilan: %4\n- Petsa/Oras: %5\nNabalaan na ang miyembrong ito ng 3 beses at na-ban na sa box, para alisin ang ban gamitin ang command na \"%6warn unban <uid>\" (kung saan uid ay ang uid ng taong gustong alisan ng ban)",
			noPermission5: "⚠️ Kailangan ng bot ng admin permission para ma-kick ang mga na-ban na miyembro",
			warnSuccess2: "⚠️ Binigyan ng babala si %1 sa ika-%2 beses\n- Uid: %3\n- Dahilan: %4\n- Petsa/Oras: %5\nKung lalabag pa siya ng %6 beses, ma-ban siya sa box",
			hasBanned: "⚠️ Ang mga sumusunod na miyembro ay nabalaan na ng 3 beses noon at na-ban na sa box:\n%1",
			failedKick: "⚠️ May naganap na error sa pag-kick sa mga sumusunod na miyembro:\n%1",
			userNotInGroup: "⚠️ Ang user na si \"%1\" ay wala sa group mo ngayon"
		}
	},
