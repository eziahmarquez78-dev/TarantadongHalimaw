...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "tingnan ang kasalukuyang panahon at forecast ng susunod na 5 araw"
		},
		category: "other",
		guide: {
			vi: "{pn} <địa điểm>",
	...
	langs: {
		...
		tl: {
			syntaxError: "Pakilagay ang lugar",
			notFound: "Hindi nahanap ang lugar: %1",
			error: "May naganap na error: %1",
			today: "Panahon ngayon: %1\n%2\n🌡 Pinakamababa - pinakamataas na temperatura %3°C - %4°C\n🌡 Pakiramdam na %5°C - %6°C\n🌅 Pagsikat ng araw %7\n🌄 Paglubog ng araw %8\n🌃 Pagsikat ng buwan %9\n🏙️ Paglubog ng buwan %10\n🌞 Araw: %11\n🌙 Gabi: %12"
		}
	},
