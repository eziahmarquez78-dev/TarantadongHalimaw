module.exports = {
	config: {
		...
		description: {
			...
			tl: "I-on/off/dagdag/burahin ang babala sa bastos na salita, kung lumabag ang miyembro babalaan siya, sa ikalawang beses kikickin sa box chat"
		},
		category: "box chat",
		guide: {
			...
			tl: "   {pn} add <words>: magdagdag ng bawal na salita (pwede maramihan, paghiwalayin ng kuwit \",\" o vertical bar \"|\")"
				+ "\n   {pn} delete <words>: burahin ang bawal na salita (pwede maramihan, paghiwalayin ng kuwit \",\" o vertical bar \"|\")"
				+ "\n   {pn} list <hide | iwanang blangko>: tignan ang listahan (idagdag ang \"hide\" para itago ang mga salita)"
				+ "\n   {pn} unwarn [<userID> | <@tag>]: alisin ang isang babala ng miyembro"
				+ "\n   {pn} on: i-on ang babala"
				+ "\n   {pn} off: i-off ang babala"
		}
	},
	...
	langs: {
		...
		tl: {
			onText: "on",
			offText: "off",
			onlyAdmin: "⚠️ | Admin lang ang pwedeng magdagdag ng bawal na salita sa listahan",
			missingWords: "⚠️ | Wala kang nilagay na salitang gustong ibawal",
			addedSuccess: "✅ | Nadagdag ang %1 na bawal na salita sa listahan",
			alreadyExist: "❌ | Nasa listahan na ang %1 na bawal na salita: %2",
			tooShort: "⚠️ | Hindi maidagdag ang %1 na salita dahil mas maikli sa 2 karakter: %2",
			onlyAdmin2: "⚠️ | Admin lang ang pwedeng magbura ng bawal na salita sa listahan",
			missingWords2: "⚠️ | Wala kang nilagay na salitang gustong burahin",
			deletedSuccess: "✅ | Nabura ang %1 na bawal na salita sa listahan",
			notExist: "❌ | Wala sa listahan ang %1 na bawal na salita: %2",
			emptyList: "⚠️ | Wala pang bawal na salita sa listahan ng group mo",
			badWordsList: "📑 | Listahan ng bawal na salita sa group mo: %1",
			onlyAdmin3: "⚠️ | Admin lang ang pwedeng mag-%1 ng feature na ito",
			turnedOnOrOff: "✅ | Na-%1 na ang babala sa bawal na salita",
			onlyAdmin4: "⚠️ | Admin lang ang pwedeng mag-alis ng babala sa bawal na salita",
			missingTarget: "⚠️ | Wala kang nilagay na user ID o na-tag na user",
			notWarned: "⚠️ | Hindi pa nababalaan si %1 sa bawal na salita",
			removedWarn: "✅ | Naalis na ang isang babala sa bawal na salita ni %1 | %2",
			warned: "⚠️ | Nadetect ang bawal na salitang \"%1\" sa mensahe mo, kung ulitin mo pa ma-kick ka sa group.",
			warned2: "⚠️ | Nadetect ang bawal na salitang \"%1\" sa mensahe mo, 2 beses ka nang lumabag kaya kikickin ka na sa group.",
			needAdmin: "Kailangan ng bot ng admin permission para ma-kick ang mga na-ban na miyembro",
			unwarned: "✅ | Naalis na ang babala sa bawal na salita ni %1 | %2"
		}
	},
