...
module.exports = {
	config: {
		...
		description: {
			...
			tl: "i-on ang do not disturb mode, kapag na-tag ka magpapaalam ang bot"
		},
		category: "box chat",
		guide: {
			...
			tl: "   {pn} [iwanang blangko | <dahilan>]: i-on ang do not disturb mode"
				+ "\n   {pn} off: i-off ang do not disturb mode"
		}
	},
	...
	langs: {
		...
		tl: {
			turnedOff: "✅ | Na-off na ang do not disturb mode",
			turnedOn: "✅ | Na-on na ang do not disturb mode",
			turnedOnWithReason: "✅ | Na-on na ang do not disturb mode dahil sa: %1",
			turnedOnWithoutReason: "✅ | Na-on na ang do not disturb mode",
			alreadyOn: "Busy si %1 sa ngayon",
			alreadyOnWithReason: "Busy si %1 sa ngayon dahil sa: %2"
		}
	},
